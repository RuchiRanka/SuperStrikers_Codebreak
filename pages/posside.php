...
<?php endif; ?>       
          <button onclick="myFunction()" type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#posMODAL">SUBMIT</button>
          <script>
            function myFunction() {
              window.location.href = "../Agents/item-info/item-info.php";
            }
          </script>
